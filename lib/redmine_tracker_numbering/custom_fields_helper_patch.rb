module TrackerNumbering
  module CustomFieldsHelperPatch
    def render_tracker_numbering_select(custom_field)
...
unless CustomFieldsHelper.included_modules
                         .include?(TrackerNumbering::CustomFieldsHelperPatch)
  CustomFieldsHelper.send :include, TrackerNumbering::CustomFieldsHelperPatch
end
